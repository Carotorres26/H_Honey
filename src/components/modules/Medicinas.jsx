...
  { id: 4, NombreMedicina: "Medicina D", Cantidad: "1", Dosis: "3ml", HorarioAdministracion: "08:00 AM", Estado: 'Administrado' }, 

  { id: 5, NombreMedicina: "Medicina E", Cantidad: "2", Dosis: "7ml", HorarioAdministracion: "12:00 PM", Estado: 'No Administrado' }, 

  { id: 6, NombreMedicina: "Medicina F", Cantidad: "5", Dosis: "9ml", HorarioAdministracion: "06:00 PM", Estado: 'Administrado' } 
...
  if (name === 'NombreMedicina') { 

    const isValidFirstCharacter = /^[a-zA-Z]/.test(value); // Comprobar si el primer carácter es una letra 
...
      nombreMedicinaError: isValidFirstCharacter ? '' : 'El nombre debe comenzar con una letra.' 
...
    this.setState({ data: lista, filteredData: lista, modalAñadir: false, currentPage: 1 }); // Reset to page 1 
...
        this.setState({ data: lista, filteredData: lista, currentPage: 1 }); // Reset to page 1 
...
    const currentData = this.state.filteredData.slice((this.state.currentPage - 1) * this.state.itemsPerPage, this.state.currentPage * this.state.itemsPerPage); 
